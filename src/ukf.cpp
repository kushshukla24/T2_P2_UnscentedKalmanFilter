...
void UKF::ProcessMeasurement(MeasurementPackage meas_package) {
  ...
  */
  ...
  double delta_time = (meas_package.timestamp_ - time_us_)/1000000.;
  time_us_ = meas_package.timestamp_;
...
void UKF::Prediction(double delta_t) {
  ...
  */
  GenerateAndPredictSigmaPoints(delta_t);
...
void UKF::UpdateLidar(MeasurementPackage meas_package) {
  ...
  MatrixXd K = P_ * Ht * Si;
	...
	VectorXd NIS_laser = (meas_package.raw_measurements_ - z_pred).transpose() * S.inverse() *
...
void UKF::UpdateRadar(MeasurementPackage meas_package) {
  ...
  */
  ...
  VectorXd NIS_radar = (meas_package.raw_measurements_ - z_pred).transpose() * S.inverse() *
	  (meas_package.raw_measurements_ - z_pred);
...
void UKF::GenerateAndPredictSigmaPoints(double delta_t) {
